...
// GetNewsletterConfig mocks base method.
func (m *MockStore) GetNewsletterConfig() (*NewsletterConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNewsletterConfig")
	ret0, _ := ret[0].(*NewsletterConfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetNewsletterConfig indicates an expected call of GetNewsletterConfig.
func (mr *MockStoreMockRecorder) GetNewsletterConfig() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNewsletterConfig", reflect.TypeOf((*MockStore)(nil).GetNewsletterConfig))
}
...
// GetWatchedVideos mocks base method.
func (m *MockStore) GetWatchedVideos() ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWatchedVideos")
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetWatchedVideos indicates an expected call of GetWatchedVideos.
func (mr *MockStoreMockRecorder) GetWatchedVideos() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWatchedVideos", reflect.TypeOf((*MockStore)(nil).GetWatchedVideos))
}

// IsVideoWatched mocks base method.
func (m *MockStore) IsVideoWatched(videoID string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsVideoWatched", videoID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IsVideoWatched indicates an expected call of IsVideoWatched.
func (mr *MockStoreMockRecorder) IsVideoWatched(videoID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsVideoWatched", reflect.TypeOf((*MockStore)(nil).IsVideoWatched), videoID)
}
...
// SetNewsletterConfig mocks base method.
func (m *MockStore) SetNewsletterConfig(config *NewsletterConfig) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetNewsletterConfig", config)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetNewsletterConfig indicates an expected call of SetNewsletterConfig.
func (mr *MockStoreMockRecorder) SetNewsletterConfig(config any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetNewsletterConfig", reflect.TypeOf((*MockStore)(nil).SetNewsletterConfig), config)
}
...
// SetVideoWatched mocks base method.
func (m *MockStore) SetVideoWatched(videoID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetVideoWatched", videoID)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetVideoWatched indicates an expected call of SetVideoWatched.
func (mr *MockStoreMockRecorder) SetVideoWatched(videoID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
